...
public class JMSBankFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JMSBankFrame abnFrame = new JMSBankFrame("Abn Amro", BankTypes.ABN.toString());
					abnFrame.setVisible(true);
					JMSBankFrame ingFrame = new JMSBankFrame("Ing",BankTypes.ING.toString());
					ingFrame.setVisible(true);
					JMSBankFrame raboFrame = new JMSBankFrame("Rabobank",BankTypes.RABO.toString());
	 ...
	 * Create the frame.
	 */
	public JMSBankFrame(String name, final String QueueName){
		setTitle(name);
		...
		btnSendReply.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				BankInterestReply reply = new BankInterestReply(interest, QueueName,rr.getRequest().getId());
		...
		gateway = new BankGateway(this,QueueName);
